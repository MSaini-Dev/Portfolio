  ...
  return (
    <div style={styles.container}>
      <div ref={wrapperRef} style={{ position: "relative" }}>
        <p ref={headingRef} style={styles.heading} className="text-6xl text-left font-bold">
           Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet natus cumque alias consequuntur quae eaque, minima laboriosam velit quas nesciunt sed, molestias quibusdam illo dignissimos pariatur, explicabo et earum enim?
            <br/>
            --Mohit Saini
        </p>
